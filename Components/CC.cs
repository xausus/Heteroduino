...
namespace Heteroduino
{
    public class CC : HetroBase_Component, IArduinoController
    {
        ...
        {
            this.Target = Target.Updated(board);
        }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("PinMode", "P",
                "PIN Mode : 0: Digital    1: PWM   2: Servo" + Resources.PinParam, GH_ParamAccess.item, 0);
        ...
        public override bool AppendMenuItems(ToolStripDropDown menu)
        {
            ...
            if (Target.Board_Type != BoardType.Uno)
            {
                ...
                for (int i = 0; i < TargetState.UnoPins.Length; i++)
                    Menu_AppendItem(menu, "PIN: " + TargetState.UnoPins[i], changePin, TargetState.CheckUnoMode(MOD, i),
                        p == i);
